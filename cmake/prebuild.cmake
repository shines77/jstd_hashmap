...
## Description: Ported from jstd/Makefile.prebuild
...
if (DEFINED CORE AND CMAKE_CROSSCOMPILING AND NOT (${HOST_OS} STREQUAL "WINDOWSSTORE"))
    ...
    # compile getarch
    set(GETARCH_SRC
        ${PROJECT_SOURCE_DIR}/tools/cpuid/get_arch.c
        ${CPUIDEMU}
    )
    ...
    set(GETARCH_DIR "${PROJECT_BINARY_DIR}/tools/get-arch")
    set(GETARCH_BIN "get-arch${CMAKE_EXECUTABLE_SUFFIX}")
    file(MAKE_DIRECTORY ${GETARCH_DIR})
    configure_file(${TARGET_CONF_TEMP} ${GETARCH_DIR}/${TARGET_CONF} COPYONLY)
    if (NOT "${CMAKE_SYSTEM_NAME}" STREQUAL "WindowsStore")
        try_compile(GETARCH_RESULT ${GETARCH_DIR}
            SOURCES ${GETARCH_SRC}
            COMPILE_DEFINITIONS ${EXFLAGS} ${GETARCH_FLAGS} -I"${GETARCH_DIR}" -I"${PROJECT_SOURCE_DIR}/tools/cpuid/" -I"${PROJECT_BINARY_DIR}"

...
void jstd_group15_flat_map_benchmark()
{
#if USE_JSTD_GROUP15_FALT_MAP
    jtest::BenchmarkResult test_result;
    test_result.setName("std::unordered_map", "jstd::group15_flat_map");
...

    {
        ...
        std::unordered_map<int, int>        std_map_ii;
        jstd::group15_flat_map<int, int>    jstd_dict_ii;
...

    {
        ...
        std::unordered_map<std::size_t, std::size_t>        std_map_uu;
        jstd::group15_flat_map<std::size_t, std::size_t>    jstd_dict_uu;
...

    {
        ...
        //
        {
            ...
            std::unordered_map<jstd::string_view, jstd::string_view>        std_map_svsv;
            jstd::group15_flat_map<jstd::string_view, jstd::string_view>    jstd_dict_svsv;
...
int main(int argc, char * argv[])
{
    ...
    if (1)
    {
        jstd_group15_flat_map_benchmark();
        jstd::Console::ReadKey();
    }
#endif
